...
__decorate([
    (0, swagger_2.ApiProperty)({ example: 10, description: 'XP points to add' }),
...
__decorate([
    (0, common_1.Post)('xp/add'),
    (0, swagger_1.ApiOperation)({ summary: 'Add XP — updates level, streak, daily goal, leaderboard' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, AddXpDto]),
    __metadata("design:returntype", void 0)
], GamificationController.prototype, "addXp", null);
__decorate([
    (0, common_1.Get)('streak'),
    (0, swagger_1.ApiOperation)({ summary: 'Get current streak and 30-day activity calendar' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get top 30 users in current league for this week' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
